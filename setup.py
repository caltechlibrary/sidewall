...
# The following reads the variables without doing an "import sidewall",
...
version = {}
with open(path.join(here, 'sidewall/__version__.py')) as f:
...
setup(
    ...
    keywords         = "research metrics network API library",
    packages         = ['sidewall'],
