...
class Person(DimensionsCore):
    ...
    def _update_attributes(self, data):
        ...
        set_objattr(self, 'first_name', data.get('first_name', ''))
        set_objattr(self, 'last_name', data.get('last_name', ''))
        set_objattr(self, 'id', data.get('id') or data.get('researcher_id') or '')
        set_objattr(self, 'orcid', data.get('orcid_id') or data.get('orcid') or '')
